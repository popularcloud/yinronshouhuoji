 ...
 * 数据接收器
 */
public class SerialDataReceiver implements DataReceiver {

    private ByteBuffer mByteBuffer;
    private ValidDataCallback mCallback;

    public SerialDataReceiver(int bufferSize) {
        mByteBuffer = ByteBuffer.allocate(bufferSize);
        mByteBuffer.clear();
    }
    ...
    @Override
    public void setValidDataCallback(ValidDataCallback callback) {
        mCallback = callback;
    }
